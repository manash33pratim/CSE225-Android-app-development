package com.manash.cse225_notes.unit_4
...
class CustomViewEditTextDemo(context: Context, attrs: AttributeSet?) :
    ...
    fun init() {
        darkButton = ResourcesCompat.getDrawable(resources, R.drawable.baseline_close_dark, null)
        lightButton = ResourcesCompat.getDrawable(resources, R.drawable.baseline_close_light, null)
    ...
    init {
        ...
        try {
            ...
            setcolor = tarry1.getBoolean(
                R.styleable.EditTextCustom_setColor1, false
            )
            if (setcolor)
